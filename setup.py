...
setup(
    name="celldb-etl-rnaseqer",
    description="Tool for adding data from EBI RNA-seqer API to celldb",
    packages=["celldb.etl.rnaseqer"],
    namespace_packages=["celldb", "celldb.etl"],
    zip_safe=False,
    url="https://github.com/david4096/celldb-etl-rnaseqer",
    version=1.0,
    entry_points={
        'console_scripts':
            ["celldb-etl-rnaseqer=celldb.etl.rnaseqer.rnaseqer:main"]
    },
